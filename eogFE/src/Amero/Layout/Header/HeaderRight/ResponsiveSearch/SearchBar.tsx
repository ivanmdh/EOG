        ...
        <div className="form-group w-100">
          <div className="Typeahead Typeahead--twitterUsers">
            <div className="u-posRelative">
              <Input className="demo-input Typeahead-input form-control-plaintext border-0 w-100" type="text" placeholder={SearchAdmiroTheme} value={searchedWord} onChange={(e) => handleSearch(e)} />
